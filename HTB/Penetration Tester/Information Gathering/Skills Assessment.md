...
![[assets/information-gathering-skills-01-target-overview.png]]

- 先從 Academy 給的 target `154.57.164.66:31076` 開始做基本探測。

![[assets/information-gathering-skills-02-target-nmap-scan.png]]

- 先跑 `nmap -sV -sC` 看看這個 target 對外開了什麼。
- 這裡沒有拿到太多服務細節，只知道 `31076/tcp` 對外開著。

![[assets/information-gathering-skills-03-target-http-response.png]]
...
![[assets/information-gathering-skills-04-whois-inlanefreight-iana-id.png]]
...
![[assets/information-gathering-skills-05-http-server-nginx.png]]
...
![[assets/information-gathering-skills-07-vhost-enum-section-overview.png]]
...
![[assets/information-gathering-skills-06-hidden-admin-path.png]]

- 枚舉結果裡可以看到 `web1337.inlanefreight.htb:31076` 回傳 `200`，表示這個 vhost 是有效的。

![[assets/information-gathering-skills-08-vhost-enum-admin-result.png]]

- 接著改對 `web1337.inlanefreight.htb:31076` 做內容枚舉，可以找到 `robots.txt`。

![[assets/information-gathering-skills-09-hidden-admin-api-key.png]]

- 查看 `robots.txt` 後會看到 `Disallow: /admin_h1dd3n`，這就是題目說的 hidden admin directory。

![[assets/information-gathering-skills-10-hidden-admin-api-key-confirmation.png]]
...
![[assets/information-gathering-skills-12-reconspider-root-results.png]]
...
![[assets/information-gathering-skills-13-reconspider-web1337-results.png]]

- 對 `web1337` 再做一次 crawl 之後，`results.json` 裡一樣沒有直接拿到 email。

![[assets/information-gathering-skills-14-reconspider-web1337-email.png]]
...
![[assets/information-gathering-skills-15-reconspider-dev-email.png]]
...
![[assets/information-gathering-skills-16-developer-next-api-key.png]]
