...
![information-gathering-main-01-whois-paypal-query](assets/information-gathering-main-01-whois-paypal-query.png)

- 先對 `paypal.com` 做 WHOIS lookup。

![information-gathering-main-02-whois-paypal-iana-id](assets/information-gathering-main-02-whois-paypal-iana-id.png)
...
![information-gathering-main-03-whois-tesla-query](assets/information-gathering-main-03-whois-tesla-query.png)

- 同樣先對 `tesla.com` 做 WHOIS 查詢。

![information-gathering-main-04-whois-tesla-admin-email](assets/information-gathering-main-04-whois-tesla-admin-email.png)
...
![information-gathering-main-06-dns-a-record-inlanefreight](assets/information-gathering-main-06-dns-a-record-inlanefreight.png)
...
![information-gathering-main-07-dns-ptr-record-result](assets/information-gathering-main-07-dns-ptr-record-result.png)
...
![information-gathering-main-09-dns-mx-facebook](assets/information-gathering-main-09-dns-mx-facebook.png)
...
![information-gathering-main-10-subdomain-section-overview-01](assets/information-gathering-main-10-subdomain-section-overview-01.png)

- 這一段是在做子網域枚舉，先把可能的 subdomain 跑出來。

![information-gathering-main-11-subdomain-section-overview-02](assets/information-gathering-main-11-subdomain-section-overview-02.png)

- 再從枚舉結果裡篩出有效的項目。

![information-gathering-main-12-subdomain-result-my-inlanefreight](assets/information-gathering-main-12-subdomain-result-my-inlanefreight.png)
...
![information-gathering-main-13-zone-transfer-section-overview](assets/information-gathering-main-13-zone-transfer-section-overview.png)
...
![information-gathering-main-14-zone-transfer-results](assets/information-gathering-main-14-zone-transfer-results.png)
...
![information-gathering-main-15-virtual-hosts-section-overview](assets/information-gathering-main-15-virtual-hosts-section-overview.png)
...
![information-gathering-main-16-virtual-hosts-gobuster-command](assets/information-gathering-main-16-virtual-hosts-gobuster-command.png)
...
![information-gathering-main-17-virtual-hosts-gobuster-output](assets/information-gathering-main-17-virtual-hosts-gobuster-output.png)

- 從輸出裡先收集 `web` 開頭的候選 vhost。

![information-gathering-main-19-virtual-hosts-http-400-response](assets/information-gathering-main-19-virtual-hosts-http-400-response.png)

- 直接用這些名稱存取時先遇到 `400`，表示還需要把 hostname 正確綁到目標 IP。

![information-gathering-main-18-virtual-hosts-hosts-file-entry](assets/information-gathering-main-18-virtual-hosts-hosts-file-entry.png)
...
![information-gathering-main-20-fingerprinting-section-overview](assets/information-gathering-main-20-fingerprinting-section-overview.png)
...
![information-gathering-main-21-fingerprinting-http-headers](assets/information-gathering-main-21-fingerprinting-http-headers.png)
...
![information-gathering-main-22-fingerprinting-dirsearch-command](assets/information-gathering-main-22-fingerprinting-dirsearch-command.png)
...
![information-gathering-main-23-fingerprinting-dirsearch-output](assets/information-gathering-main-23-fingerprinting-dirsearch-output.png)

- 從掃描結果裡找可疑路徑，再往下確認是不是特定 CMS。

![information-gathering-main-24-fingerprinting-joomla-indicator](assets/information-gathering-main-24-fingerprinting-joomla-indicator.png)
...
![information-gathering-main-25-reconspider-results-json](assets/information-gathering-main-25-reconspider-results-json.png)
...
![information-gathering-main-28-web-archives-htb-labs-query](assets/information-gathering-main-28-web-archives-htb-labs-query.png)

- 先把時間切到 `2018-08-08` 附近的快照。

![information-gathering-main-29-web-archives-htb-labs-count](assets/information-gathering-main-29-web-archives-htb-labs-count.png)
...
![information-gathering-main-30-web-archives-htb-members-count](assets/information-gathering-main-30-web-archives-htb-members-count.png)
...
![information-gathering-main-26-web-archives-facebook-query](assets/information-gathering-main-26-web-archives-facebook-query.png)

- 先回到 `2002-03` 左右的快照。

![information-gathering-main-27-web-archives-facebook-redirect](assets/information-gathering-main-27-web-archives-facebook-redirect.png)
...
![information-gathering-main-31-web-archives-paypal-palm-organizer](assets/information-gathering-main-31-web-archives-paypal-palm-organizer.png)
...
![information-gathering-main-32-web-archives-google-prototype](assets/information-gathering-main-32-web-archives-google-prototype.png)
...
![information-gathering-main-33-web-archives-iana-last-updated](assets/information-gathering-main-33-web-archives-iana-last-updated.png)
...
![information-gathering-main-34-web-archives-wikipedia-article-count](assets/information-gathering-main-34-web-archives-wikipedia-article-count.png)
