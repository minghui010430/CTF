...
![](img/提權/解出Root_session.png)

![](img/提權/選擇Root_sessions.png)
- 切換到Root的session
- ***-i***  是值 interactive

![](img/提權/open_shell.png)
- 在這裡可以可以看到是Root的權限
...
![](img/提權2/使用reverse_bash.png)
- 利用reverse bash反向連線

![](img/提權2/netcat_連線.png)
- 利用nc連接到伺服器
